 ...
 * {@link FormatType#XLS_LANGUAGE}. A map of {@link Keyword}s and their
...
public class ExcelLanguageCentricParser implements ExcelParser {
     ...
     */
    public ExcelLanguageCentricParser() {
    ...
    /**
     * Column 0 keyword Column 1 context Column 2 Bundle Column 3 Country Column
     * 4..n Languages
     * 
     * @param lrec
     */
    ...
    /**
     * @return the list of {@link Language}s used in this file, or an empty list
     *         if no {@link Language}s were specified
     */
